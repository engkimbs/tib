...
extern "C" void TibrvQueue_CompleteCB(tibrvQueue queue, void *closure);

class TibrvQueue : public TibrvDispatchable
{
    friend void TibrvQueue_CompleteCB(tibrvQueue queue, void *closure);
...
public:
    ...
    tibrvDispatchable getDispatchable() const
                { return static_cast<tibrvDispatchable>(_queue); }
...
public:
    ...
    tibrvDispatchable getDispatchable() const
                { return static_cast<tibrvDispatchable>(_queueGroup); }
...
public:
    ...
    TibrvStatus requestReliability(tibrv_f64 reliability);
...
extern "C" void TibrvEvent_ListenCB (tibrvEvent event, tibrvMsg msg,
                                     void *closure);
extern "C" void TibrvEvent_TimerCB  (tibrvEvent event, tibrvMsg msg,
                                     void *closure);
extern "C" void TibrvEvent_IoCB     (tibrvEvent event, tibrvMsg msg,
                                     void *closure);
extern "C" void TibrvEvent_CompleteCB(tibrvEvent event, void *closure);

extern "C" void TibrvEvent_VectorListenCB ( tibrvMsg msg[], tibrv_u32 nrMessages);

class TibrvEvent
{

    friend void TibrvEvent_ListenCB (tibrvEvent event, tibrvMsg msg,
                                     void *closure);
    friend void TibrvEvent_VectorListenCB ( tibrvMsg messages[],
                                            tibrv_u32 numMessages);
    friend void TibrvEvent_TimerCB  (tibrvEvent event, tibrvMsg msg,
                                     void *closure);
    friend void TibrvEvent_IoCB     (tibrvEvent event, tibrvMsg msg,
                                     void *closure);
    friend void TibrvEvent_CompleteCB(tibrvEvent event, void *closure);
...
private:
    ...
    TibrvVectorListener(const TibrvVectorListener& listener);
    TibrvVectorListener& operator=(const TibrvVectorListener& listener);
...
public:
    TibrvVectorCallback() {}
    virtual ~TibrvVectorCallback() {}

    virtual void onMsgs(TibrvMsg* messages[], tibrv_u32 numMessages) = 0;
...
public:
    ...
    TibrvEvent*  getEvent()const { return _event; }
    void         setEvent(TibrvEvent* eventPtr){_event = eventPtr;}
