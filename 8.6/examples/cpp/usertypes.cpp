    ...
    tibrvMsgDataType*   data_type)
{
    ...
    field->data.str = (char *) tibrvMsgData_Malloc(strlen(str)+1);
    ...
    tibrvMsgDataType*   data_type)
{
    ...
    field->data.str = (char *) tibrvMsgData_Malloc(strlen(fieldString)+1);
    if ( field->data.str == NULL )
        return TIBRV_NO_MEMORY;

    strcpy((char*)field->data.str,fieldString);
